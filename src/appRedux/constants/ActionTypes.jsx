...
export const userActTypes = {
  ...
  LOGIN_VIA_GOOGLE_SUCCESS: 'LOGIN_VIA_GOOGLE_SUCCESS',
  LOGIN_VIA_GOOGLE_FAILED:'LOGIN_VIA_GOOGLE_FAILED',
  ...
  CLEAR_USER_NOTIF_STATUS: 'CLEAR_USER_NOTIF_STATUS',
  ...
  GET_WATCHLIST_FAVORITES: 'GET_WATCHLIST_FAVORITES',
  ...
  GET_SELLING_BIDS: 'GET_SELLING_BIDS',
  GET_SELLING_BIDS_SUCCESS: 'GET_SELLING_BIDS_SUCCESS',
  GET_SELLING_ORDERS: 'GET_SELLING_ORDERS',
  GET_SELLING_ORDERS_SUCCESS: 'GET_SELLING_ORDERS_SUCCESS',
  GET_LISTING_STATUS: 'GET_LISTING_STATUS',
  GET_LISTING_STATUS_SUCCESS: 'GET_LISTING_STATUS_SUCCESS',
  GET_CHAT_USERS: 'GET_CHAT_USERS',
  GET_CHAT_USERS_SUCCESS: 'GET_CHAT_USERS_SUCCESS',
  GET_CHAT_MSG: 'GET_CHAT_MSG',
  GET_CHAT_MSG_SUCCESS: 'GET_CHAT_MSG_SUCCESS',
  SEND_CHAT: 'SEND_CHAT',
  SEND_CHAT_SUCCESS: 'SEND_CHAT_SUCCESS',
  DELETE_CHAT: 'DELETE_CHAT',
  DELETE_CHAT_SUCCESS: 'DELETE_CHAT_SUCCESS',
  DELETE_SELL_LISTING: 'DELETE_SELL_LISTING',
  DELETE_SELL_LISTING_SUCCESS: 'DELETE_SELL_LISTING_SUCCESS',
  DELETE_SELL_LISTING_BIDS_SUCCESS: 'DELETE_SELL_LISTING_BIDS_SUCCESS',
  GET_ONLINE_STATUS: 'GET_ONLINE_STATUS',
  GET_ONLINE_STATUS_SUCCESS: 'GET_ONLINE_STATUS_SUCCESS',
  GET_ONLINE_STATUS_FAILED: 'GET_ONLINE_STATUS_FAILED',
}
