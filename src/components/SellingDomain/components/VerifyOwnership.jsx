...
const HtmlFileContent = () => {
  ...
  return (<>
    <Row  className={classes.htmlFileContent}>
      <span className={classes.fontDecor}>Please click on the button to download the file, insert it to the root folder of your site and click on ‘Verify’.</span>
      <Row >
...
const VerifyOwnershipCard = ({imgSrc, details, itemKey, onClickContent, isSelected}) => {
  ...
  return(
    <Col xs={24} md={8}>
      <Card hoverable className={classes.vocCard}
        onClick={() => onClickContent(itemKey)}
      >
