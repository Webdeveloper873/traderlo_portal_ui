  ...
  return(
    <>
      ...
      <PageWrapper className={classes.pageWrapper}>
        <Tabs className={classes.tabStyle} activeKey={"3"} onNextClick={moveToNextTab} defaultActiveKey="1" onChange={callback} size="large" tabBarGutter={120} tabBarStyle={{fontWeight:600}}>
